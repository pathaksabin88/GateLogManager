...
<h1 style="text-align:center;color:red;"><strong>Its Time To PUNCH-OUT</strong></h1>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <div style="text-align:center;font-size:20px;">
        <form role="form" style="background-color:lightgrey;" action="processPunchOut" method="GET">
          <input type="hidden" name="page" value="processPunchOut">
          <div style="text-align:center;font-size:40px;background-color: #ffff00">
            <h1 style="font-family: FontAwesome; font-size: 50px;">Thanks For Visiting DeerWalk</h1>
          </div>
          <br><br>
          <div style="text-align:center;font-size:20px;">
            <input type="submit" value="Punch Out" name="proceed" class="btn btn-warning" style="font-size:40px; height:80px; width:300px">
          </div>
          <br><br>
        </form>
      </div>
